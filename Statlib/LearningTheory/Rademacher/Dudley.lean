...
import Statlib.LearningTheory.EmpiricalProcess.FunctionClass
...
cover cardinalities use `coveringNumberNat`, the finite view of Statlib's canonical covering number.

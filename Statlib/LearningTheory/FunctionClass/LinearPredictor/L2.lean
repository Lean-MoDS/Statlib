...
-/
import Statlib.LearningTheory.Rademacher.Symmetrization
...
This module uses Euclidean spaces and the empirical Rademacher complexity from `Statlib.LearningTheory.Rademacher.Defs`.

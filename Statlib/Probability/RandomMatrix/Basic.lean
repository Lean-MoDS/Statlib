...
import Statlib.Probability.Process.FiniteMaximum
...
`IsENet` from `Statlib.Topology.MetricSpace.CoveringNumber.Basic`; this structure only packages the domain and codomain nets
